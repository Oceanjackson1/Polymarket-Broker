...
import * as __fd_glob_8 from "../content/docs/getting-started/rate-limits.mdx?collection=docs"
import * as __fd_glob_7 from "../content/docs/getting-started/quickstart.mdx?collection=docs"
import * as __fd_glob_6 from "../content/docs/getting-started/authentication.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "api-reference/meta.json": __fd_glob_1, "guides/meta.json": __fd_glob_2, "getting-started/meta.json": __fd_glob_3, }, {"changelog.mdx": __fd_glob_4, "index.mdx": __fd_glob_5, "getting-started/authentication.mdx": __fd_glob_6, "getting-started/quickstart.mdx": __fd_glob_7, "getting-started/rate-limits.mdx": __fd_glob_8, "guides/btc-multiframe.mdx": __fd_glob_9, "guides/convergence-arbitrage.mdx": __fd_glob_10, "guides/nba-fusion-trading.mdx": __fd_glob_11, "api-reference/analysis.mdx": __fd_glob_12, "api-reference/auth.mdx": __fd_glob_13, "api-reference/data-btc.mdx": __fd_glob_14, "api-reference/data-nba.mdx": __fd_glob_15, "api-reference/data-sports.mdx": __fd_glob_16, "api-reference/markets.mdx": __fd_glob_17, "api-reference/orders.mdx": __fd_glob_18, "api-reference/portfolio.mdx": __fd_glob_19, "api-reference/strategies.mdx": __fd_glob_20, });